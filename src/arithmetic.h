/**************************************************************************************
 * Macros and inline functions for integral arithmetics. Note that all indices are
 * interpreted as Euclidean modulo 64 values. Also note that most of the operations are
 * defined as generic macros in order to permit function overloading.
 **************************************************************************************/
